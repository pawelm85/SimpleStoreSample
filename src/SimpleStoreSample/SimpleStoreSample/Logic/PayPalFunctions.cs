...
public class NVPAPICaller
{
    ...
    public string APIUsername = "pawelm85-facilitator_api1.gmail.com";
    private string APIPassword = "EPhK6jyS3rqI8r19h_o41murWFebKBYqvTzXm4gJeWo7NpRcIIwY0jav4W0JRQYh_sU0UtwLJo7mGBO0";
    private string APISignature = "AVRjs9UGDm7Gp7UInyBOcfdT3tPKAwlBdmv7BBssTpTjGdC4zdt9Tk5j";
    ...
    public string HttpCall(string NvpRequest)
    {
        ...
        {
            // Log the exception.
           // SimpleStoreSample.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
        }
